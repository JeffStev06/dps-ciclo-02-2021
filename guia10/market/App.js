...
class listarProductos extends React.Component {
  ...
  render() {
    return (
      <View style={{flex:1}} >
        <NavigationEvents
          onWillFocus={() => { this.CargarRegistros(); }}
        />
        <Text
          style={{fontSize:18, textAlign:'center', height:40, marginTop:10, backgroundColor:'lightgray', textAlignVertical:'center', borderRadius:10, marginLeft:10, marginRight:10}}>
    ...
    return (
      <View style={{flex:1}}>
        <ScrollView style={{flex:1}}>
          <View
            style={{flex:1,flexDirection:'row',alignContent:'center',alignItems:'center',height:60}}
          >
            <TouchableOpacity
